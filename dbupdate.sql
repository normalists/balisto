USE [hackathon]
GO
/****** Object:  StoredProcedure [dbo].[normalist_update_averages]    Script Date: 21/03/2015 04:40:48 ******/
SET ANSI_NULLS ON
GO
...
--else
--	begin
		insert into averages_data(gsn,valor,[timestamp],price,currencyCode,valueType,statisticType,valueStyle)
		values(@GSN,@valor,@timestamp,@price,@currencyCode,@valueType,@statisticType,@valueStyle)
	--end


GO
/****** Object:  UserDefinedFunction [dbo].[normalist_fn_get_average]    Script Date: 21/03/2015 04:40:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[normalist_fn_gsn_to_timestamp]    Script Date: 21/03/2015 04:40:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[averages_data]    Script Date: 21/03/2015 04:40:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[averages_data](
	[GSN] [bigint] NOT NULL,
	[valor] [int] NOT NULL,
	[timestamp] [datetime] NULL CONSTRAINT [DF_averages_data_timestamp]  DEFAULT (getdate()),
...
GO
/****** Object:  Table [dbo].[mdf_stream_emulated]    Script Date: 21/03/2015 04:40:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
